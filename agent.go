...
// QueryNanomdmusers queries the "nanomdmusers" edge of the Agent entity.
func (a *Agent) QueryNanomdmusers() *NanoMDMUserQuery {
	return NewAgentClient(a.config).QueryNanomdmusers(a)
}
