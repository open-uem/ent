...
func (_d *SessionsDelete) Where(ps ...predicate.Sessions) *SessionsDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *SessionsDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *SessionsDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *SessionsDelete) sqlExec(ctx context.Context) (int, error) {
...
// Where appends a list predicates to the SessionsDelete builder.
func (_d *SessionsDeleteOne) Where(ps ...predicate.Sessions) *SessionsDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *SessionsDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *SessionsDeleteOne) ExecX(ctx context.Context) {
