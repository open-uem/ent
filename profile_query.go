...
func (_q *ProfileQuery) QueryTags() *TagQuery {
...
func (_q *ProfileQuery) QueryTasks() *TaskQuery {
...
func (_q *ProfileQuery) QueryIssues() *ProfileIssueQuery {
...
func (_q *ProfileQuery) QuerySite() *SiteQuery {
...
func (_q *ProfileQuery) WithTags(opts ...func(*TagQuery)) *ProfileQuery {
	query := (&TagClient{config: _q.config}).Query()
...
func (_q *ProfileQuery) WithTasks(opts ...func(*TaskQuery)) *ProfileQuery {
	query := (&TaskClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ProfileQuery) WithIssues(opts ...func(*ProfileIssueQuery)) *ProfileQuery {
	query := (&ProfileIssueClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ProfileQuery) WithSite(opts ...func(*SiteQuery)) *ProfileQuery {
	query := (&SiteClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ProfileQuery) loadTags(ctx context.Context, query *TagQuery, nodes []*Profile, init func(*Profile), assign func(*Profile, *Tag)) error {
...
func (_q *ProfileQuery) loadTasks(ctx context.Context, query *TaskQuery, nodes []*Profile, init func(*Profile), assign func(*Profile, *Task)) error {
...
func (_q *ProfileQuery) loadIssues(ctx context.Context, query *ProfileIssueQuery, nodes []*Profile, init func(*Profile), assign func(*Profile, *ProfileIssue)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int]*Profile)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
...
func (_q *ProfileQuery) loadSite(ctx context.Context, query *SiteQuery, nodes []*Profile, init func(*Profile), assign func(*Profile, *Site)) error {
