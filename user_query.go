...
func (_q *UserQuery) QuerySessions() *SessionsQuery {
	query := (&SessionsClient{config: _q.config}).Query()
...
func (_q *UserQuery) WithSessions(opts ...func(*SessionsQuery)) *UserQuery {
	query := (&SessionsClient{config: _q.config}).Query()
...
func (_q *UserQuery) loadSessions(ctx context.Context, query *SessionsQuery, nodes []*User, init func(*User), assign func(*User, *Sessions)) error {
