...
type LogicalDisk struct {
	...
	// BitlockerConversionStatus holds the value of the "bitlocker_conversion_status" field.
	...
	// BitlockerKeyProtectorsTypes holds the value of the "bitlocker_key_protectors_types" field.
	BitlockerKeyProtectorsTypes string `json:"bitlocker_key_protectors_types,omitempty"`
	// BitlockerPassphrase holds the value of the "bitlocker_passphrase" field.
...
func (ld *LogicalDisk) assignValues(columns []string, values []any) error {
	...
	for i := range columns {
		...
		case logicaldisk.FieldBitlockerConversionStatus:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field bitlocker_conversion_status", values[i])
			} else if value.Valid {
				ld.BitlockerConversionStatus = int32(value.Int64)
			}
		case logicaldisk.FieldBitlockerEncryptionPercentage:
			if value, ok := values[i].(*sql.NullInt64); !ok {
				return fmt.Errorf("unexpected type %T for field bitlocker_encryption_percentage", values[i])
			} else if value.Valid {
		...
		case logicaldisk.FieldBitlockerOperationInProgress:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field bitlocker_operation_in_progress", values[i])
			} else if value.Valid {
		...
		case logicaldisk.FieldBitlockerIsAutoUnlockEnabled:
			if value, ok := values[i].(*sql.NullBool); !ok {
				return fmt.Errorf("unexpected type %T for field bitlocker_is_auto_unlock_enabled", values[i])
			} else if value.Valid {
		...
		case logicaldisk.FieldBitlockerKeyProtectorsTypes:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field bitlocker_key_protectors_types", values[i])
			} else if value.Valid {
				ld.BitlockerKeyProtectorsTypes = value.String
			}
		case logicaldisk.FieldBitlockerPassphrase:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field bitlocker_passphrase", values[i])
			} else if value.Valid {
				ld.BitlockerPassphrase = value.String
			}
		case logicaldisk.FieldBitlockerPassphraseVolumeKeyProtectorID:
			if value, ok := values[i].(*sql.NullString); !ok {
				return fmt.Errorf("unexpected type %T for field bitlocker_passphrase_volume_key_protector_id", values[i])
			} else if value.Valid {
...
func (ld *LogicalDisk) String() string {
	...
	builder.WriteString(", ")
	builder.WriteString("bitlocker_conversion_status=")
	builder.WriteString(fmt.Sprintf("%v", ld.BitlockerConversionStatus))
	builder.WriteString(", ")
	builder.WriteString("bitlocker_encryption_percentage=")
	...
	builder.WriteString(", ")
	builder.WriteString("bitlocker_key_protectors_types=")
	builder.WriteString(ld.BitlockerKeyProtectorsTypes)
	builder.WriteString(", ")
	builder.WriteString("bitlocker_passphrase=")
	builder.WriteString(ld.BitlockerPassphrase)
	builder.WriteString(", ")
