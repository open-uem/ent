...
func (_c *SessionsCreate) SetID(v string) *SessionsCreate {
	_c.mutation.SetID(v)
	return _c
}

// SetOwnerID sets the "owner" edge to the User entity by ID.
func (_c *SessionsCreate) SetOwnerID(id string) *SessionsCreate {
	_c.mutation.SetOwnerID(id)
	return _c
}

// SetNillableOwnerID sets the "owner" edge to the User entity by ID if the given value is not nil.
func (_c *SessionsCreate) SetNillableOwnerID(id *string) *SessionsCreate {
	if id != nil {
		_c = _c.SetOwnerID(*id)
	}
	return _c
...
func (_c *SessionsCreate) SetOwner(v *User) *SessionsCreate {
...
func (_c *SessionsCreate) check() error {
	...
	if v, ok := _c.mutation.ID(); ok {
		if err := sessions.IDValidator(v); err != nil {
			return &ValidationError{Name: "id", err: fmt.Errorf(`ent: validator failed for field "Sessions.id": %w`, err)}
		}
	}
	return nil
}
...
func (u *SessionsUpsertOne) ID(ctx context.Context) (id string, err error) {
	if u.create.driver.Dialect() == dialect.MySQL {
		...
		return id, errors.New("ent: SessionsUpsertOne.ID is not supported by MySQL driver. Use SessionsUpsertOne.Exec instead")
	}
