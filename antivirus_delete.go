...
func (_d *AntivirusDelete) Where(ps ...predicate.Antivirus) *AntivirusDelete {
	_d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query and returns how many vertices were deleted.
func (_d *AntivirusDelete) Exec(ctx context.Context) (int, error) {
	return withHooks(ctx, _d.sqlExec, _d.mutation, _d.hooks)
}

// ExecX is like Exec, but panics if an error occurs.
func (_d *AntivirusDelete) ExecX(ctx context.Context) int {
	n, err := _d.Exec(ctx)
	if err != nil {
		panic(err)
	}
...
func (_d *AntivirusDelete) sqlExec(ctx context.Context) (int, error) {
...
// Where appends a list predicates to the AntivirusDelete builder.
func (_d *AntivirusDeleteOne) Where(ps ...predicate.Antivirus) *AntivirusDeleteOne {
	_d._d.mutation.Where(ps...)
	return _d
}

// Exec executes the deletion query.
func (_d *AntivirusDeleteOne) Exec(ctx context.Context) error {
...
// ExecX is like Exec, but panics if an error occurs.
func (_d *AntivirusDeleteOne) ExecX(ctx context.Context) {
