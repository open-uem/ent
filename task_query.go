...
func (tq *TaskQuery) QueryProfile() *ProfileQuery {
...
func (tq *TaskQuery) WithProfile(opts ...func(*ProfileQuery)) *TaskQuery {
	query := (&ProfileClient{config: tq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (tq *TaskQuery) loadTags(ctx context.Context, query *TagQuery, nodes []*Task, init func(*Task), assign func(*Task, *Tag)) error {
...
func (tq *TaskQuery) loadProfile(ctx context.Context, query *ProfileQuery, nodes []*Task, init func(*Task), assign func(*Task, *Profile)) error {
