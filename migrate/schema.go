...
var (
	...
	MdmCommandsColumns = []*schema.Column{
		...
		{Name: "type", Type: field.TypeEnum, Nullable: true, Enums: []string{"DeviceInformation", "UsersList", "InstalledApplicationsList"}, Default: "DeviceInformation"},
	...
	NanoMdmInfosColumns = []*schema.Column{
		...
		{Name: "previous_scan_result", Type: field.TypeInt, Nullable: true, Default: 0},
	...
	NanoMdmUsersColumns = []*schema.Column{
		{Name: "id", Type: field.TypeInt, Increment: true},
		{Name: "data_quota", Type: field.TypeInt, Nullable: true},
		{Name: "data_used", Type: field.TypeInt, Nullable: true},
	...
	NanoMdmUsersTable = &schema.Table{
		Name:       "nano_mdm_users",
		Columns:    NanoMdmUsersColumns,
		PrimaryKey: []*schema.Column{NanoMdmUsersColumns[0]},
		ForeignKeys: []*schema.ForeignKey{
			{
				Symbol:     "nano_mdm_users_agents_nanomdmusers",
				Columns:    []*schema.Column{NanoMdmUsersColumns[11]},
				RefColumns: []*schema.Column{AgentsColumns[0]},
				OnDelete:   schema.Cascade,
			},
		},
...
func init() {
	...
	NanoMdmUsersTable.ForeignKeys[0].RefTable = AgentsTable
