...
func (_q *SettingsQuery) QueryTag() *TagQuery {
...
func (_q *SettingsQuery) QueryTenant() *TenantQuery {
...
func (_q *SettingsQuery) WithTag(opts ...func(*TagQuery)) *SettingsQuery {
	query := (&TagClient{config: _q.config}).Query()
...
func (_q *SettingsQuery) WithTenant(opts ...func(*TenantQuery)) *SettingsQuery {
	query := (&TenantClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
//		GroupBy(settings.FieldLanguage).
//		Aggregate(ent.Count()).
//		Scan(ctx, &v)
...
func (_q *SettingsQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Settings, error) {
	...
	if _q.withTag != nil || _q.withTenant != nil {
		withFKs = true
	}
	if withFKs {
...
func (_q *SettingsQuery) loadTag(ctx context.Context, query *TagQuery, nodes []*Settings, init func(*Settings), assign func(*Settings, *Tag)) error {
...
func (_q *SettingsQuery) loadTenant(ctx context.Context, query *TenantQuery, nodes []*Settings, init func(*Settings), assign func(*Settings, *Tenant)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*Settings)
	for i := range nodes {
...
func (_q *SettingsQuery) Modify(modifiers ...func(s *sql.Selector)) *SettingsSelect {
...
// Modify adds a query modifier for attaching custom logic to queries.
func (_s *SettingsSelect) Modify(modifiers ...func(s *sql.Selector)) *SettingsSelect {
